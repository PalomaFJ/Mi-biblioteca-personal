...
function App() {
  const [libros, setLibros] = useState([
    ...
    { id: 6, titulo: 'Todas deberíamos ser feministas', autor: 'Chimamanda Ngozi Adichie', leido: true },
    ...
    { id: 21, titulo: 'La moral anarquista', autor: 'Piotr Kropotkin', leido: true },
    { id: 22, titulo: 'Teoría King Kong', autor: 'Virginie Despentes', leido: true },
    { id: 23, titulo: 'Muerte de un anarquista en las escalinatas del palacio', autor: 'Osvaldo Bayer', leido: true },
    ...
    { id: 28, titulo: 'Ansia', autor: 'Henar Álvarez', leido: true }
  ]);
